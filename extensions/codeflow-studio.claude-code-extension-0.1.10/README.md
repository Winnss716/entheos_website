...
<div align="center">
  <img src="https://github.com/codeflow-studio/claude-code-chat/raw/HEAD/resources/claude-icon.png" alt="Claude Code" width="100">
</div>
...
<div align="center">
  <img src="https://github.com/codeflow-studio/claude-code-chat/raw/HEAD/media/screenshots/context-files.png" alt="File Context" width="70%" style="border-radius: 8px; margin: 10px 0; box-shadow: 0 4px 8px rgba(0,0,0,0.2);">
</div>
...
<div align="center">
  <img src="https://github.com/codeflow-studio/claude-code-chat/raw/HEAD/media/screenshots/launch-options.png" alt="Smart Launch Options" width="70%" style="border-radius: 8px; margin: 10px 0; box-shadow: 0 4px 8px rgba(0,0,0,0.2);">
</div>
...
<div align="center">
  <img src="https://github.com/codeflow-studio/claude-code-chat/raw/HEAD/media/screenshots/image-support.png" alt="Image Support" width="70%" style="border-radius: 8px; margin: 10px 0; box-shadow: 0 4px 8px rgba(0,0,0,0.2);">
</div>
...
<div align="center">
  <img src="https://github.com/codeflow-studio/claude-code-chat/raw/HEAD/media/screenshots/quick-fix-menu.png" alt="Quick Fix Integration" width="70%" style="border-radius: 8px; margin: 10px 0; box-shadow: 0 4px 8px rgba(0,0,0,0.2);">
</div>
...
<div align="center">
  <img src="https://github.com/codeflow-studio/claude-code-chat/raw/HEAD/media/screenshots/slash-commands.png" alt="Slash Commands" width="70%" style="border-radius: 8px; margin: 10px 0; box-shadow: 0 4px 8px rgba(0,0,0,0.2);">
</div>
...
<div align="center">
  <img src="https://github.com/codeflow-studio/claude-code-chat/raw/HEAD/media/screenshots/auto-start-settings.png" alt="Auto-Start Configuration Settings" width="70%" style="border-radius: 8px; margin: 10px 0; box-shadow: 0 4px 8px rgba(0,0,0,0.2);">
</div>

Access these settings through VSCode preferences: `File > Preferences > Settings` and search for "Claude Code Extension".

See our [documentation](https://github.com/codeflow-studio/claude-code-chat/tree/main/docs) for detailed guides, including [how to create custom slash commands](https://github.com/codeflow-studio/claude-code-chat/blob/HEAD/docs/custom-slash-commands.md).
...
- 🔧 **[Troubleshooting Guide](https://github.com/codeflow-studio/claude-code-chat/blob/HEAD/TROUBLESHOOTING.md)** - Fix common issues like service worker errors
...
MIT License - see [LICENSE.md](https://github.com/codeflow-studio/claude-code-chat/blob/HEAD/LICENSE.md) for details

## Contributing

We welcome contributions! Please see our [Contributing Guide](https://github.com/codeflow-studio/claude-code-chat/blob/HEAD/CONTRIBUTING.md) for details.
