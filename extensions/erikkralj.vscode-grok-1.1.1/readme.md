...
![Demo GIF](https://github.com/eriktodx/vscode-grok/raw/HEAD/resources/demo1.gif)
...
This extension is licensed under the [MIT License](https://github.com/eriktodx/vscode-grok/blob/HEAD/LICENSE). See the license file for more details.
